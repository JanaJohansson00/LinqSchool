...
namespace LinqSchool.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public StudentsController(LinqSchoolDbContext context)
        {
            _context = context;
        }
        ...
        {
            var linqSchoolDbContext = _context.Students.Include(s => s.Class);
            return View(await linqSchoolDbContext.ToListAsync());
        }
